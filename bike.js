...
function bike (color,cvs, form)
{
    ...
    {
	var ttY = BB[1] - this.stack; // Y coordinate of top tube
	var seatX = BB[0] - (this.ttl - this.reach); // X of top of seat tube
	var axleY = BB[1] - this.bbDrop; // Y coordinate of axles
	...
	// upper end of fork
	var forkTX = BB[0] + this.reach + this.htl*Math.cos(this.hta/180*Math.PI);
	var forkTY = ttY + this.htl* Math.sin(this.hta/180*Math.PI);
	...
	var stemAngleAct = (90-this.hta + this.sa)/180*Math.PI;
